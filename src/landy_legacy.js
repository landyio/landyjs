...
var landy = {
  init: function landyInit(config) {
    var campaign = new Landy(config.modelId,
                              config.url,
                              config.type,
                              config.subtype,
                              config.g);
  ...
  sendSuccess: function landySendSuccess(config) {
    var campaign = new Landy(config.modelId,
                              config.url,
                              config.type,
                              config.subtype,
...
function Landy(campaignId, url, type, subtype, goals) {
  ...
  var userIdKey = 'landy-uid';
  var variationsKey = 'landy-variations';
  var goalsKey = 'landy-goals';
  var timeStorageExpireId = 'landy-expire';
