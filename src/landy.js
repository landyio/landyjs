...
function Landy(campaignId, url, type, subtype, goals) {
  ...
  var _parsedUA = _parser.getResult();
  ...
  function generateIdentity() {
    var userData = {
      browser: (function() {
        return _parsedUA.browser.name;
      })(),
      browserV: (function() {
        return _parsedUA.browser.name + ' ' + _parsedUA.browser.major;
      })(),
      devType: (function() {
        return _parsedUA.device.type || '';
      })(),
      device: (function() {
        return _parsedUA.device.model || '';
      })(),
      vendor: (function() {
        return _parsedUA.device.vendor || '';
      })(),
      lang: (function() {
      ...
      mobile: (function() {
        return +(_parsedUA.device.type === 'mobile') + '';
      })(),
      screen: (function() {
      ...
      os: (function() {
        return _parsedUA.os.name;
      })(),
      osVersion: (function() {
        return _parsedUA.os.name + ' ' + _parsedUA.os.version;
      })(),
